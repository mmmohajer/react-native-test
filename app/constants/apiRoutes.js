...
export const GOOGLE_AUTH_HANDLE_TOKEN_API_ROUTE =
  "/api/auth/google-auth-handle-token/";
export const MICROSOFT_AUTH_TOKEN_API_ROUTE = "/api/auth/microsoft-auth/";
export const MICROSOFT_AUTH_HANDLE_TOKEN_API_ROUTE =
  "/api/auth/microsoft-auth-handle-token/";
export const FACEBOOK_AUTH_TOKEN_API_ROUTE = "/api/auth/facebook-auth/";
export const FACEBOOK_AUTH_HANDLE_TOKEN_API_ROUTE =
  "/api/auth/facebook-auth-handle-token/";
export const CAPTCHA_API_ROUTE = "/api/captcha/";
export const STRIPE_CREATE_PAYMENT_INTENT_API_ROUTE =
  "/api/create-payment-intent/";
export const STRIPE_RETRIEVE_PAYMENT_INTENT_API_ROUTE =
  "/api/retrieve-payment-intent/";
export const STRIPE_CREATE_SETUP_INTENT_API_ROUTE = "/api/create-setup-intent/";
export const STRIPE_RETRIEVE_SETUP_INTENT_API_ROUTE =
  "/api/retrieve-setup-intent/";
export const STRIPE_ADD_ACTIVE_CARD_FOR_CUSTOMER =
